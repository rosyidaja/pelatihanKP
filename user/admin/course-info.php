...
<div class="tbcourse">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="align-middle">
            ...
            if ($namaMar == 'ani') {
              // code...
              echo "Submit<br>Internet";
            } else {
              // code...
              echo "Approved<br>by $namaMar";
            }
            ?>
          </td>
          <td class="align-middle" style="display:block;">
            ...
            <span>
              <button type="button" class="btn btn-danger btn-sm cancel" id="cancel<?php echo $regno;?>" data-num="<?php echo $regno;?>"><i class="fa fa-times"></i> Cancel</button>
            </span>
            <span>
              <button type="button" class="btn btn-success btn-sm selesai" id="selesai<?php echo $regno;?>" data-num="<?php echo $regno;?>"><i class="fa fa-check"></i> Selesai</button>
            </span>
          </td>
  ...
  <?php } else {
    // code...
    echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" name="button">&times</button><strong>Data masih kosong!</strong></div>';
  } ?>
</div>
