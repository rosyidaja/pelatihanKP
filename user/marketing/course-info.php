...
$query = mysqli_query($koneksi, "SELECT * FROM m_peserta GROUP BY peserta_instansi_nama ORDER BY peserta_id ASC");
$query2 = mysqli_query($koneksi, "SELECT * FROM m_peserta ORDER BY peserta_id ASC");
?>
          ...
          <div class="modal-body">
            ...
            <div class="tbdtlpsrta table-responsive">
              ...
              <table class="table table-striped table-hover table-sm text-center">
                ...
                <tbody>
                  <?php $qmtable = mysqli_query($koneksi, "SELECT jns_pelatihan_kode, peserta_id, peserta_nama  FROM m_peserta WHERE peserta_instansi_nama = '$instansi'"); ?>
                  <?php if (mysqli_num_rows($qmtable)>0) { ?>

                    <?php while ($data = mysqli_fetch_array($qmtable)) {
                      // code...
                      $mtable_pel = $data["jns_pelatihan_kode"];
                      $mtable_id = $data["peserta_id"];
